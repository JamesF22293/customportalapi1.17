...
//        CustomPortalApiRegistry.addPortal(Blocks.GLOWSTONE, PortalIgnitionSource.WATER, portalBlock, new Identifier("the_nether"), 2, 3, 55, 89, 195);
//        CustomPortalApiRegistry.addPortal(Blocks.CRYING_OBSIDIAN, PortalIgnitionSource.FIRE, new Identifier("the_nether"), 67, 247, 198);
